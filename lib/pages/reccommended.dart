...
import 'package:hairmarket/utils/hair.dart';
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Recommended for you', style: bigtextStyle()),
          centerTitle: true,
          elevation: 0.0,
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  Text(hairs[index].price, style: TextStyle(fontSize: 12)),
